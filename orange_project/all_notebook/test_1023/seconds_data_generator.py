import requests
import os
from datetime import datetime  # Ensure that you have imported datetime correctly
import zipfile
        ...
        for current_date in (start_date + datetime.timedelta(n) for n in range((end_date - start_date).days + 1)):
            ...
            with zipfile.ZipFile(zip_filename, 'r') as zip_ref:
                for file_info in zip_ref.infolist():
                    ...
                    if not os.path.exists(extracted_file_path):  # Check for typos, it should be 'os.path.exists'
...
class Dataframe_calc_indicator:
    ...
    def prepare_dataframe(self):
        ...
        df_copy = df_copy.sort_values(by='real_1s')  # This line might be causing the issue
        return df_copy
